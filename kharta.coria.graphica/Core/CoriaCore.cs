...
{
    public class CoriaCore : IPlugin, IInstallablePlugin
    {
        public string Name { get { return "Coria Applications Core"; } }
        public string Description { get { return "Provides the Coria Data Model and installs and upgrades a Kharta database using EF"; } }
        ...
        public void Install(Version lastInstalledVersion)
        {
            ...
            if (lastInstalledVersion == null || lastInstalledVersion.Major == 0)
            {
                ...
                InstallSql("MapBookCreateTable.sql");
